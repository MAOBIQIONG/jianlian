...
public class GetPushMessageResultDemo {
	//您应用的mastersecret
	private static final String MASTERSECRET = "Kx7lRbyk2P7kTaa9zBCInA";
	//您应用的appkey
	private static final String APPKEY = "0hCg34H6j77XQEZ29VX0n3";
	//要查询的taskId
	private static final String APPID = "JVRHJnTO1Z8aFM4XM0W0a1";
...
//		System.out.println("总下发数:"+msgTotal+"|点击数:"+clickNum+"|下发的消息总数:"+msgProcess);
		...
		IQueryResult result = push.queryAppUserDataByDate(APPID, "20160314");

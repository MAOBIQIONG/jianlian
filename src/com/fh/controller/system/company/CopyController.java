...
public class CopyController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception {
		...
		mv.setViewName("system/copy/business");
		return mv;
	}
	...
	public ModelAndView querypanyid()throws Exception{
		...
		mv.setViewName("system/copy/add-pany");
	...
	public ModelAndView toaddcyl()throws Exception{
		...
		mv.setViewName("system/copy/business_gs");
		return mv;
	}
	...
	public String querysuoyoupany(Page page)throws Exception{
		...
		List data = this.copyService.listByParam(page);
		Object  total = this.copyService.findCount(page).get("counts");//查询记录的总行数
	...
	public ModelAndView look()throws Exception{
		...
		mv.setViewName("system/copy/look-com-logo");
	...
	public ModelAndView querybywsxx()throws Exception{
		...
		mv.setViewName("system/copy/wsxx-members");
		mv.addObject("ru", ru); 

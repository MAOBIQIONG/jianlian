...
import com.fh.service.Govers.GoversDFService;
...
public class GoversdfController extends BaseController {  
	
	@Resource(name = "goversDFService")
	private GoversDFService goversDFService;   
		 
	@RequestMapping
	public ModelAndView list() throws Exception {
		ModelAndView mv = getModelAndView();
		mv.setViewName("system/Goverstment/Goversdaifa_list");
		return mv;
	}
	...
	public String queryPageList(Page page) throws Exception {
		...
		List<PageData> data = this.goversDFService.listPage(page);
		Object	total = this.goversDFService.findCount(page).get("counts");//查询记录的总行数 
	...
	public String delete() {
		...
		try {
			pd = getPageData(); 
			this.goversDFService.delete(pd); 
		} catch (Exception e) {
	...
	public String updateStatus() {
		...
		try {
			pd = getPageData();  
			Object ob=this.goversDFService.edit(pd);

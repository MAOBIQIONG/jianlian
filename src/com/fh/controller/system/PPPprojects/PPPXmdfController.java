...
import com.fh.service.system.PPPprojectService.PPPXmDfService;
import com.fh.util.PageData; 
import com.fh.util.SystemLog;  

@Controller
@RequestMapping({ "/PPPxmdf" })
public class PPPXmdfController extends BaseController {  
	
	@Resource(name = "PPPxmdfService")
	private PPPXmDfService PPPxmDfService;   
		 
	@RequestMapping
	public ModelAndView list() throws Exception {
		ModelAndView mv = getModelAndView();
		mv.setViewName("system/PPPprojects/PPPdaifa_list");
		return mv;
	}
	...
	public String queryPageList(Page page) throws Exception {
		...
		List<PageData> data = this.PPPxmDfService.listPage(page);
		Object	total = this.PPPxmDfService.findCount(page).get("counts");//查询记录的总行数 
	...
	public String updateStatus() {
		...
		try {
			pd = getPageData();  
			Object ob=this.PPPxmDfService.edit(pd);

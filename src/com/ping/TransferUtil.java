...
public class TransferUtil { 
	    ...
	    public static void runDemos(String appId) {
	    	...
	    	TransferUtil transferExample = new TransferUtil(appId);
	    ...
	    public Transfer transfer() {
	        ...
	        String orderNo = "099327489";//new SimpleDateFormat("yyyyMMddhhmmss").format(new Date()) + Main.randomString(7);

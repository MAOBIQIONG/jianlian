...
public class WebhooksVerifyUtil { 
		...
		private static String pubKeyPath = PingConfig.getString("ping.pingppPublicKeyPath"); 
		private static String eventPath = PingConfig.getString("ping.eventPath");
		private static String signPath =PingConfig.getString("ping.signPath"); 
		/**
		 * 验证 webhooks 签名，仅供参考
		 * @param args
		 * @throws Exception

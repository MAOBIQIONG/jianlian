...
<div class="page-container"> 
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	    <span class="l">
	        <a href="javascript:;" onclick="img_del('<%=basePath%>xmtp/delImg.do?PRO_ID=${pro.ID}')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>  
		    <a id="img-add" class="btn btn-primary radius" data-title="添加图片" onclick="img_edit('添加图片','<%=basePath%>xmtp/toAdd.do?PRO_ID=${pro.ID}','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>添加图片</a>
		    <a id="img-add" class="btn btn-primary radius" data-title="添加封面" onclick="img_edit('添加封面','<%=basePath%>xmtp/toAddCover.do?PRO_ID=${pro.ID}','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>添加项目封面</a>
		</span> 
	</div>

		...
		<div>
			...
			<div class="page-container">
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"> 
					    <a class="btn btn-primary radius"  href="javascript:void(0)" onclick="project_check('<%=basePath%>project/updateStatus.do?STATUS=6')"><i class="Hui-iconfont">&#xe600;</i>完成交易</a></span>   
					</span>  
				</div>
		 ...
		 var table;
			$(function() {
				...
				table = $('.table-sort').dataTable({
	                ...
	                "sAjaxSource": "<%=basePath%>project/queryPageList.do",//这个是请求的地址
					...
					{  
	                 ...
	                 {  
	                     "sClass":"center", 
	                     "mDataProp" : "PART_COUNT", 
	                     "aTargets":[9],  
	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
                            return '<a _href=\"<%=basePath%>proBidder/toBidder.do?PROJECT_ID='+c.ID+'&BIDDER_ID='+c.BID_WINNER_ID+'\" data-title=\"查看参与人员\" class=\"btn btn-link\" onclick=\"Hui_admin_tab(this)\" href=\"javascript:;\"  >'+c.PART_COUNT+'</a>';
                         }  
	                 }, 
	                 {  
	                     "sClass":"center", 
	                     "mDataProp" : "WINNER_NAME", 
	                     "aTargets":[10],  
	                     "mData":"WINNER_NAME" 
	                 }, 
	                 {  
	                 ...
	                 }, 
	                 {
	                     ...
	                     "aTargets":[13],  
	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
	                     	return '<a data-title=\"编辑\" onclick=\"project_edit(\'编辑中标信息\',\'<%=basePath%>project/gozhongbiao.do?ID='+c.ID+'\',\'\',\'300\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i> 编辑</a>&nbsp;&nbsp;<a data-title=\"删除\" href=\"javascript:;\" onclick=\"project_del(\'<%=basePath%>project/delete.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
	                    }  
	                 }
					], 

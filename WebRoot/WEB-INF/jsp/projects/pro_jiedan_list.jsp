				...
				table = $('.table-sort').dataTable({
					...
					{  
	                 ...
	                 {  
	                     ...
	                     "aTargets":[10],  
	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
                            return '<a _href=\"<%=basePath%>proBidder/toBidder.do?PROJECT_ID='+c.ID+'&BIDDER_ID='+c.BID_WINNER_ID+'\" data-title=\"查看参与人员\" class=\"btn btn-link\" onclick=\"Hui_admin_tab(this)\" href=\"javascript:;\"  >'+c.TOTAL_BIDDER+'</a>';
                         }  
	                 }, 
	                 {  
	                     "sClass":"center", 

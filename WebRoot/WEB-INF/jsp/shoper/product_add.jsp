   ...
   padding:0px;
	...
	<body>
		<article class="page-container">
			...
			<input type="hidden" value="${SHOP_ID}" id="SHOP_ID" name="SHOP_ID">  
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品ID：</label>
				    <div class="formControls col-xs-8 col-sm-9">
						<input type="text" value="${PROD_ID}" class="input-text" name="PROD_ID" id="PROD_ID" readOnly>
					</div> 
				</div> 
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品编号：</label>
				    <div class="formControls col-xs-8 col-sm-9">
						<input type="text" value="${PROD_NO}" class="input-text" name="PROD_NO" id="PROD_NO">
					</div> 
				</div> 
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" value="" class="input-text" placeholder="" id="prod_name" name="prod_name">
					</div> 
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9"> 
						<input type="text" class="input-text" value="0" id="express_price" name="express_price" />
					</div>
				</div> 
				<!-- <div class="row cl">
				...
				<div class="row cl" id="sx_1">
					...
					<div class="formControls col-xs-8 col-sm-9"> 
						属性名：<input type="text" value="" class="input-text" title="例：属性名称：产地，属性值为：中国上海" style="width: 300px;" name="prod_sxn" id="prod_sxn" placeholder="属性名"/>
						属性值：<input type="text" value="" class="input-text" name='prod_sxz' id='prod_sxz' style="width: 300px;" title='注：该值中不能含英文逗号' placeholder='属性值' />
					</div>
				</div> 
				...
				<div class="row cl" id="gg_1">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品规格：</label>
					<div class="formControls col-xs-8 col-sm-9"> 
						规格名：<input type="text" value="" class="input-text" title="例：规格名称：颜色，规格值为：白色#黑色" style="width: 300px;" name="prod_ggn" id="prod_ggn" placeholder="规格名"/>
						规格值：<input type="text" value="" class="input-text" name='prod_ggz' id='prod_ggz' style="width: 300px;" title="注：多个值以#号隔开；例：黑色#白色" onchange="resSku()" placeholder="规格值1#规格值2#规格值3..." />
					</div>
				</div> 
				...
				<div class="row cl" style="margin-top: -20px;">
					...
					<div class="formControls col-xs-8 col-sm-9"> 
						<table>
						    ...
						    <tr>
						   	   <td  style="border: 1px solid #ddd;text-align: center;height: 25px;color: red" colspan="6">
						   	 		<b>请添加产品规格生成Sku信息</b>
						   	   </td>
						    </tr>
						  	<!--<tr>
						   	   <td>1</td>
						       <td><input readonly="readonly" type="text" name="sku_n" id="sku_n" data-rule="required"
									value="aaa" size="20"></td>
						       <td><input type="text" name="num" id="num" data-rule="required"
									value="0" size="20"></td>
						       <td><input type="text" name="price" id="price" data-rule="required"
									value="0" size="20"></td>
						       <td><input type="text" name="yongjing" id="yongjing" data-rule="required"
									value="0" size="20"></td>
						    </tr> -->
						   </tbody>
						</table>
		...
		function addSku(){
			...
			if($("#prod_ggz").size() > 0){
				...
				if(f){
					...
					$("#skuinfo").append(tr);
			  	//input输入数字验证
					$("#skuinfo input").bind("input propertychange",function(){
					    var text = /^[0-9]+.?[0-9]*$/;
					    var val = this.value;
					    if (!text.test(val)){
					        this.value = "";
					        ...
					        if( val.indexOf(".") > -1 ){
					            var suf = val.substring(val.indexOf(".")+1);
					            this.value = suf.length > 2 ? val.substring(0,val.indexOf(".")+3) : val;
					        }
					    }
					});
				}else{

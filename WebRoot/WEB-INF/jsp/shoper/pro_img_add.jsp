	...
	<body class="pos-r">  
	    <article class="page-container">
		    <form class="form form-horizontal" id="form-horizontal">  
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">商品滚动图：</label>
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">顺序：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${pd.IMGORDER}" placeholder="" id="IMGORDER" name="IMGORDER">
					</div> 
				</div>
				<div class="row cl">
		...
		$(function(){
		 ...
		 function honor_save(){  
			...
			var TYPE=$('#TYPE').val(); 
			var IMGORDER=$('#IMGORDER').val();
			var img=document.getElementById("IMG_PATH").value;
			if(IMGORDER==null||IMGORDER==""||IMGORDER==undefined){
				alert("请填写图片顺序");
				return
			}
			if(img==null||img==""||img==undefined){
				...
				var url="<%=basePath%>product/uploadImgs.do?PRO_ID="+PRO_ID+"&TYPE="+TYPE+"&IMGORDER="+IMGORDER; 
				$.ajaxFileUpload({  
					  url :url,
					  type:'post',
				      secureuri:false,  

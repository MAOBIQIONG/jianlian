	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="">上海建联管理系统</a>  <span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl"> 
					<li>${user.NAME}</li> 
					<li><a id="logout"  href="<%=basePath%>appShoper/logout.do" data-title="退出登录">退出登录</a></li> 
   ...
   <aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2"> 
		<dl id="menu-system">
			...
			<dd>
				<ul> 
				    <li><a _href="<%=basePath%>appcopy" data-title="公司管理">公司管理</a></li>
					<li><a _href="<%=basePath%>appshop" data-title="店铺管理">店铺管理</a></li>
					<li><a _href="<%=basePath%>appproduct" data-title="商品管理">商品管理</a></li>
					<li><a _href="<%=basePath%>appproductOrder" data-title="订单管理">订单管理</a></li> 
				</ul>
			</dd>
	   </dl>   
	</div> 

...
<![endif]-->
	...
	<body class="pos-r"> 
		<div>
			<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>商城管理 <span class="c-gray en">&gt;</span>商品管理1
		 ...
		 var table;
			$(function() {
				...
				table = $('.table-sort').dataTable({
	                ...
	                "sAjaxSource": "<%=basePath%>appproduct/queryList.do",//这个是请求的地址

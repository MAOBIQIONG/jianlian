...
<body class="pos-r">  
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>商品管理 <span class="c-gray en">&gt;</span>商品介绍图展示
...
<div class="page-container"> 
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	    <span class="l">
		    ...
		    <a id="img-add" class="btn btn-primary radius" data-title="添加图片" onclick="img_edit('添加图片','<%=basePath%>product/toAddimg.do?TYPE=01&PRO_ID=${pd.ID}','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>添加图片</a>
		</span> 
	</div>

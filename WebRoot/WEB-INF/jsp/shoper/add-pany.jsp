...
function companyAdd(){ 
	...
	$.ajax({
            url : "<%=basePath%>appcopy/addcompany.do",
  ...
  function checkCompanyName(obj){
	  ...
	  $.ajax({
          url : "<%=basePath%>appcopy/findGsdByname.do",
...
function check1(){ 
    ...
    if(aa[aa.length-1]=='gif'||aa[aa.length-1]=='jpg'||aa[aa.length-1]=='png'||aa[aa.length-1]=='jpeg'){//判断图片格式
		...
		if(imagSize<1024*1024){ 
			var url="<%=basePath%>appcopy/addLogo.do"; 
			$.ajaxFileUpload({  
				  url :url,
				  type:'post',
			      secureuri:false,  
...
function check2(){ 
    ...
    if(aa[aa.length-1]=='gif'||aa[aa.length-1]=='jpg'||aa[aa.length-1]=='png'||aa[aa.length-1]=='jpeg'){//判断图片格式
		...
		if(imagSize<1024*1024){ 
			var url="<%=basePath%>appcopy/addBUSINESS.do"; 
			$.ajaxFileUpload({  
				  url :url,
				  type:'post',
			      secureuri:false,  
...
function check3(){ 
    ...
    if(aa[aa.length-1]=='gif'||aa[aa.length-1]=='jpg'||aa[aa.length-1]=='png'||aa[aa.length-1]=='jpeg'){//判断图片格式
		...
		if(imagSize<1024*1024){ 
			var url="<%=basePath%>appcopy/addCOVER.do"; 
			$.ajaxFileUpload({  
				  url :url,
				  type:'post',
			      secureuri:false,  

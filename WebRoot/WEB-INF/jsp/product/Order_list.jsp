		...
		<div>
			...
			<div class="page-container">
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"> 
						<a class="btn btn-primary radius" data-title="新增" onclick="shop_edit('新增','<%=basePath%>productOrder/toAdd.do','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>新增商品订单</a>	
					</span>  
				</div> 
				<div class="mt-20">
		 ...
		 var table;
			$(function() {
				...
				table = $('.table-sort').dataTable({
	                ...
	                "sAjaxSource": "<%=basePath%>productOrder/queryList.do",//这个是请求的地址

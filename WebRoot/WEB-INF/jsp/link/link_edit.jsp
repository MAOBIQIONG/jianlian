	...
	<body>
		<article class="page-container">
			<form class="form form-horizontal" id="form-horizontal">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">链接网址：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${data.LINK }" placeholder="http://" id="LINK" name="LINK" data-rule-url="true">
					</div> 
				</div> 
		 		<div class="row cl">
		...
		$(function(){
		 ...
		 function save(){  
			...
			var LINK=$("#LINK").val(); 
			var data="&COMPANY_NAME="+COMPANY+"&LINK="+LINK; 
		var url="<%=basePath%>link/save.do?ID="+ID+data; 
		$.ajaxFileUpload({  
			  url :url,
			  type:'post', 

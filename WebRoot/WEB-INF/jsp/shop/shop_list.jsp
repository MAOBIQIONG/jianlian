	...
	<body class="pos-r"> 
		<div>
			...
			<div class="page-container">
				<div class="text-c"> 
				    <div class="text-c">
					    <input type="text" name="USER_NAME" id="USER_NAME" placeholder="用户账号" style="width:250px" class="input-text">&nbsp;&nbsp;&nbsp;
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l"> 
						<a class="btn btn-primary radius" data-title="新增店铺" onclick="shop_edit('新增店铺','<%=basePath%>shop/toAdd.do','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>新增店铺</a>	
					</span>  
				</div>
				...
				<div class="mt-20">
					<table class="table table-border table-bordered table-bg table-hover table-sort">
						<thead>
							<tr class="text-c"> 
							    <th style="width: 300px">用户账号</th>
							    <th style="width: 300px">公司名称</th>
								<th style="width: 250px">店铺掌柜</th> 
								<th style="width: 250px">店铺名称</th> 
								 <th style="width: 250px">店铺描述</th>
								<th style="width: 280px">店铺头像</th>
								<th style="width: 280px">店铺主题</th>
								<th style="width: 250px">地址</th> 
								<th style="width: 250px">创建时间</th> 
								<th style="width: 150px">查看商品</th>  
								<th>操作</th>  
							</tr>
						</thead>
						<tbody> 
		 ...
		 var table;
			$(function() {
				...
				table = $('.table-sort').dataTable({
	                ...
	                "sAjaxSource": "<%=basePath%>shop/queryList.do",//这个是请求的地址
					...
					"aoColumns": [ 
	                 ...
	                 },
	                 {
	                     ...
	                     "aTargets":[10],  
	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
	                     	return '<a data-title=\"添加商品\" onclick=\"shop_edit(\'添加商品\',\'<%=basePath%>product/toAdd.do?SHOP_ID='+c.ID+'\',\'\',\'300\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i>添加商品</a>&nbsp;&nbsp;<a data-title=\"编辑\" onclick=\"shop_edit(\'编辑\',\'<%=basePath%>shop/goEdit.do?ID='+c.ID+'\',\'\',\'300\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i> 编辑</a>&nbsp;&nbsp;<a data-title=\"删除\" href=\"javascript:;\" onclick=\"shop_del(\'<%=basePath%>shop/delete.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
	                    }  
	                 } 
					],  

		...
		<div>
			...
			<div class="page-container">
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20"> 
				    <span class="l"> 
						<a class="btn btn-primary radius" data-title="新增" onclick="dic_edit('新增','<%=basePath%>dictionaries/toEdit.do?PARENT_ID=${PARENT_ID }','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 新增</a></span> 
					</span> 
				</div>
				<div class="mt-20">

...
<script type="text/javascript">
	...
	<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<tr>
				<td><input type="text" name="NAME" id="name"  value="${pd.NAME }"  maxlength="32" placeholder="姓名" title="姓名"/></td>
			</tr>
			<tr>
				<td><input type="number" name="PHONE" id="PHONE"  value="${pd.PHONE }" readonly="readonly"  maxlength="32" placeholder="手机号" title="手机号"/></td>
			</tr>
			<tr>
				<td><input type="email" name="EMAIL" id="EMAIL"  value="${pd.EMAIL }" maxlength="32" placeholder="邮箱" title="邮箱" onblur="hasE('${pd.USERNAME }')"/></td>
			</tr>
			<tr>

...
<article class="page-container">
	...
	<input type="hidden" name="ID" id="ID" value="${pad.ID }"/>   
		...
		<%-- <div class="row cl" <c:if test="${pad.STATUS !='02' }">style="display: none;"</c:if> >
			<label class="form-label col-xs-4 col-sm-2" style="color: red;"><span class="c-red">*</span>拒绝原因：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea rows="5" cols="136" id="NOPASS_REASON" name="NOPASS_REASON" readonly="readonly" placeholder="请输入拒绝原因，通过时请勿输入！">${pad.NOPASS_REASON }</textarea>
			</div>
		</div> --%>
		<div class="row cl">
		...
		<div class="row cl res" style="dispaly:none;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea rows="5" cols="136" id="NOPASS_REASON" name="NOPASS_REASON" placeholder="请输入拒绝原因！">${pad.NOPASS_REASON}</textarea>
			</div>
		</div>  
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2"> 
				<input class="btn btn-success radius" onclick="fh()" type="button" value="&nbsp;返回&nbsp;">&nbsp;&nbsp;
			</div>
		</div>
	</form>
</article>   

			...
			<form class="form form-horizontal" id="form-project-add">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${editData.PRO_NAME}" placeholder="" id="PRO_NAME" name="PRO_NAME" data-rule-required="true">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>教授职位：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${editData.PRO_TITLE}" placeholder="" id="PRO_TITLE" name="PRO_TITLE" data-rule-required="true">
					</div>
				</div>
				<div class="row ">
					...
					<div class="formControls col-xs-8 col-sm-9"> 
						<span class="btn-upload form-group"> 
							<input type="file" value="${editData.PRO_IMG }" id="PRO_IMG" name="PRO_IMG" onchange="check()" style="width:150px;" />
						</span> 
					</div>
				</div>
				<div class="row ">
					...
					<div class="formControls col-xs-8 col-sm-9"> 
						<span class="btn-upload form-group"> 
							<input type="file" value="${editData.PRO_DETAILS_IMG }" id="PRO_DETAILS_IMG" name="PRO_DETAILS_IMG" onchange="check()" style="width:150px;" />
						</span> 
					</div>
				</div> 
				<div class="row cl">

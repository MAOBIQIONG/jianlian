		...
		<article class="page-container">
			<form class="form form-horizontal" id="form-project-add">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9"> 
						<span class="select-box" style="width:150px;">  
							<select class="select" name="MANAGER" id="MANAGER" data-placeholder="请选择项目经理" style="vertical-align:top;">
								<option value="0">--请选择--</option>
								<c:forEach items="${managerList}" var="manager">
									<option value="${manager.ID }" <c:if test="${manager.ID == pd.MANAGER}">selected</c:if>>${manager.NAME }</option>
								</c:forEach>
							</select>
						</span> 
					</div> 	

	...
	<body class="pos-r"> 
		...
		$(function() {
			...
			table = $('.table-sort').dataTable({
                ...
                "sAjaxSource": "<%=basePath%>PPPxmdf/queryPageList.do",//这个是请求的地址
                ...
                "aoColumns": [{  
          	                 ...
          	                 }, 
          	                 {
          	                     ...
          	                     "aTargets":[5],  
          	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
          	                     	return '<a data-title=\"已处理\" onclick=\"del(\'<%=basePath%>PPPxmdf/update.do?ID='+c.ID+'&STATUS=02\',\'\',\'550\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i>已处理</a>&nbsp<a data-title=\"删除\" href=\"javascript:;\" onclick=\"del(\'<%=basePath%>PPPxmdf/delete.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
          	                    }  
          	                 }
          			], 

...
<div class="navbar navbar-inverse">
		  <div class="navbar-inner">
		   <div class="container-fluid">
			  <a class="brand"><small><i class="icon-leaf"></i> 幼智园管理平台</small> </a>
			  <ul class="nav ace-nav pull-right">
					...
					<li class="light-blue user-profile">
						...
						<ul id="user_menu" class="pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							...
							<li id="suggest"><a onclick="suggest();" style="cursor:pointer;"><i class="icon-cog"></i> 问题/建议</a></li>
		...
		function suggest(){
			 ...
			 diag.Drag=true;
			 diag.Title ="我有建议";
			 diag.URL = '<%=basePath%>suggest/goAdd';
			 diag.Width =  500;
			 diag.Height =  500;
			 diag.CancelEvent = function(){ //关闭事件
				parent.bootbox.alert("感谢您的宝贵建议！");
				diag.close();
			 };
			 diag.show();
		}

...
<![endif]-->
	...
	<body class="pos-r"> 
		<div>
			<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>企业管理 <span class="c-gray en">&gt;</span>会员管理
			...
			<div class="page-container">
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l">
					    ...
					    <a class="btn btn-primary radius" data-title="修改录入的会员信息" onclick="fenpei('修改录入的会员信息','<%=basePath%>tbuser/userinfo_edit.do','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>修改录入的会员信息</a>
					   ...
					   --%> <%--  <a class="btn btn-primary radius" data-title="添加用户" onclick="tiao('添加用户','<%=basePath%>tbuser/adduserid.do','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a> --%>
					    ...
					    <a class="btn btn-primary radius" data-title="完善入会时间" href="javascript:;" onclick="fenpei('完善资料','<%=basePath%>tbuser/querybywantime.do','','550')"><i class="Hui-iconfont">&#xe600;</i>完善入会时间</a>
						...
						<a href="<%=basePath%>tbuser/exportfeedback.do" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe600;</i>导出Excel</a> 
				    </span>  
				</div> 
				<div class="mt-20">
					<form id="form-mem">
	                ...
	                "bLengthChange": true, //改变每页显示数据数量 
	                 ...
	                 }, 
	                 {
	                     ...
	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
	                     	return '<a data-title=\"编辑\" onclick=\"tiao(\'编辑\',\'<%=basePath%>tbuser/querybyid.do?ID='+c.ID+'\',\'\',\'550\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i> 编辑</a>&nbsp&nbsp<a data-title=\"删除\" href=\"javascript:;\" onclick=\"delbyid(\'<%=basePath%>tbuser/delmembyid.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
	                    }  
	                 }
			], 
			 ...
			 "fnServerData" : function(sSource, aoData, fnCallback) {  
			    ...
			    var LEVEL = $("#LEVEL").val();  
				 $.ajax({
		                ...
		                data : {"aoData":JSON.stringify(aoData),"REAL_NAME":REAL_NAME,"CARD_NO":CARD_NO,"PHONE":PHONE,"USER_NAME":USER_NAME,"COMPANY_NAME":COMPANY_NAME,"VIP_LEVEL":LEVEL,"TY":1},//这个是把datatable的一些基本数据传给后台,比如起始位置,每页显示的行数
		                type : 'post',
		                dataType : 'json',
		                async : false,

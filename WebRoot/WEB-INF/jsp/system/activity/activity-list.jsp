	...
	<body class="pos-r"> 
			...
			<div class="page-container">
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20"> 
				     <span class="l">
					    ...
					    <a href="<%=basePath%>activity/exportfeedback.do" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe600;</i>导出Excel</a> 
		...
		$(function() {
			...
			table = $('.table-sort').dataTable({
                ...
                "sAjaxSource": "<%=basePath%>activity/queryList.do",//这个是请求的地址
                ...
                "aoColumns": [
                              ...
                              /* {  
                               ...
                               {  
			                     ...
			                     "aTargets":[10],  
			                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
			                         return '<a _href=\"<%=basePath%>acttp/toLookImgs.do?ID='+c.ID+'\" data-title=\"查看活动图片\" class=\"btn btn-link\" onclick=\"Hui_admin_tab(this)\" href=\"javascript:;\"  >查看图片</a>';
			                      }  
				              }, 
                              {  
			                     "sClass":"center", 
			                     ...
			                     "aTargets":[11],  
			                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
		                            return '<a _href=\"<%=basePath%>activity/toBidder.do?ACT_ID='+c.ID+'\" data-title=\"查看报名人\" class=\"btn btn-link\" onclick=\"Hui_admin_tab(this)\" href=\"javascript:;\"  >'+c.PART_COUNT+'</a>';
		                         }  
			                 },
			                 {  
          	                     "sClass":"center", 

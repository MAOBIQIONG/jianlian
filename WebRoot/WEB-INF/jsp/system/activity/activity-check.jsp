...
<article class="page-container">
	...
	<input type="hidden" name="USER_ID" id="USER_ID" value="${activityData.USER_ID }"/>   
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text valib Wdate" value="${activityData.START_DATE }" placeholder="" id="START_DATE" name="START_DATE" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" data-rule-required="true">
			</div>
		</div> 
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>结束时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text valib Wdate" value="${activityData.END_DATE }" placeholder="" id="END_DATE" name="END_DATE" data-rule-required="true"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">费用描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
			    <input type="text" class="input-text" value="${activityData.FEE_DESCRIPTION}" placeholder="" id="FEE_DESCRIPTION" name="FEE_DESCRIPTION">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
		 ...
		 <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>等级要求：</label> 
			<div class="formControls col-xs-8 col-sm-9"> 
				<c:forEach items="${userLevelList}" var="userLevel">
					<div style="margin-left: 25px;float: left;padding:2px;">
						<input type="checkbox" id="check" value="${userLevel.BIANMA}" name="LEVEL_LIMIT" <c:if test="${userLevel.flag ==1}">checked</c:if>/>${userLevel.NAME} 
					</div> 
				</c:forEach> 
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="IS_HOT" type="radio" id="flag-1" value="1"  <c:if test="${activityData.IS_HOT == '1' }">checked="checked"</c:if>>
					<label for="flag-1">是</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="flag-2" name="IS_HOT" value="0"  <c:if test="${activityData.IS_HOT == '0' }">checked="checked"</c:if>>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal" id="STATUS">
				<div class="radio-box">
					<input name="STATUS" type="radio" id="flag-1" value="03" <c:if test="${activityData.STATUS == '03' }">checked="checked"</c:if>>
					<label for="flag-1">审核通过</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="flag-2" name="STATUS" value="02" <c:if test="${activityData.STATUS == '02' }">checked="checked"</c:if>>
					<label for="flag-2">审核不通过</label>
				</div> 
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>不通过原因：</label>
			<div class="formControls col-xs-8 col-sm-9">
			    <input type="text" class="input-text" value="${activityData.NOPASSREASON}" placeholder="" id="NOPASSREASON" name="NOPASSREASON">
			</div>
		</div> 
		<div class="row cl">
...
function companyAdd(){ 
	var chk_value =[]; 
	$("input[name='LEVEL_LIMIT']:checked").each(function(){ 

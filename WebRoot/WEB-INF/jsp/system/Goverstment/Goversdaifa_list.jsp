...
<![endif]-->
		<title>政府招商代发项目</title> 
	</head>

	<body class="pos-r"> 
		<div>
			<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>政府招商管理<span class="c-gray en">&gt;</span>政府招商代发项目
		...
		$(function() {
			...
			table = $('.table-sort').dataTable({
                ...
                "sAjaxSource": "<%=basePath%>notify/queryPageList.do",//这个是请求的地址
                ...
                "aoColumns": [{  
      	                 ...
      	                 },  
      	                 {
      	                     ...
      	                     "aTargets":[5],  
      	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
      	                     	return '<a data-title=\"已处理\" onclick=\"del(\'<%=basePath%>notify/update.do?ID='+c.ID+'&STATUS=02\',\'\',\'550\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i>已处理</a>&nbsp<a data-title=\"删除\" href=\"javascript:;\" onclick=\"del(\'<%=basePath%>notify/delete.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
      	                    }  
      	                 }
          			], 

...
<div class="page-container">
	<div class="text-c" style="text-align: left;"> 
    	...
    	<a class="btn btn-success radius" style="line-height:1.6em;"  href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i>刷新</a>
	</div> 
	...
	$(function() {
		...
		table = $('.table-sort').dataTable({
			...
			"bProcessing": false, // 是否显示取数据时的那个等待提示
             ...
             "sAjaxSource": "<%=basePath%>copy/queryc.do",//这个是请求的地址

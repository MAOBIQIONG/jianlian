...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		<a class="btn btn-primary radius" data-title="添加公司" onclick="tiao('添加公司','<%=basePath%>copy/querypanyid.do','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加公司信息</a>
		<%-- <a class="btn btn-primary radius" data-title="添加公司到产业链" onclick="tiao('添加公司到产业链','<%=basePath%>copy/toaddcyl.do','','450')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加公司到产业链</a> --%>
		<a class="btn btn-primary radius" data-title="公司荣誉" href="javascript:;" onclick="fenpei('公司荣誉','<%=basePath%>copy/querybywsxx.do','','550')"><i class="Hui-iconfont">&#xe600;</i>公司荣誉</a>
		</span> 
		 </div>
	<div class="mt-20">
		<form id="form-pany">
	...
	$(function() {
		...
		table = $('.table-sort').dataTable({
			...
			"bProcessing": false, // 是否显示取数据时的那个等待提示
	              ...
	              "sAjaxSource": "<%=basePath%>copy/querysuoyoupany.do",//这个是请求的地址
					...
					{  
                     ...
                     {  
                         ...
                         "mRender":function(a,b,c,d){
 	                    	if(c.LOGO!=null&&c.LOGO!=''&&c.LOGO.indexOf("http://")>=0){ 
                      			return '<img class="wt_img" src="'+c.LOGO+'"></img>';
                           	}else if(c.LOGO!=null&&c.LOGO!=''&&c.LOGO.indexOf("http://")<0){ 
	                 ...
	                 }, 
	                 {
	                     ...
	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
	                     	return '<a data-title=\"编辑\" onclick=\"tiao(\'编辑\',\'<%=basePath%>copy/querypanyid.do?COMPANY_ID='+c.COMPANY_ID+'\',\'\',\'550\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i> 编辑</a>&nbsp<a data-title=\"删除\" href=\"javascript:;\" onclick=\"delbyid(\'<%=basePath%>copy/delcompanybyid.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
	                    }  
	                 }
			], 

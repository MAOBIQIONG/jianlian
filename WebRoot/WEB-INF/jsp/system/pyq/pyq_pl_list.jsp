	...
	<body class="pos-r"> 
		...
		$(function() {
			...
			table = $('.table-sort').dataTable({
                ...
                "sAjaxSource": "<%=basePath%>friends/queryPLList.do",//这个是请求的地址
				...
				"aoColumns": [  
				 {  
				    ...
				    "mRender":function(a,b,c,d){//c表示当前记录行对象  
				        return '<input class=\"'+c.ID+'\" type=\"checkbox\" name=\"ids\" value=\"'+c.ID+'\">';  
				     }  
				 }, 
                    {  
                       	"sClass":"center", 
                    ...
                    },
                    {
                     ...
                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
                     	return '<a data-title=\"删除\" href=\"javascript:;\" onclick=\"project_del(\'<%=basePath%>friends/pldelete.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
                    }  
                 }
				],

	...
	<body class="pos-r"> 
		<div>
			...
			<div class="page-container">
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20"> 
				     <span class="l">
					    <a class="btn btn-primary radius" data-title="添加" onclick="edit('添加','<%=basePath%>service/toEdit.do','','550')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
					</span> 
                </div>
				<div class="mt-20">
		...
		$(function() {
			...
			table = $('.table-sort').dataTable({
                ...
                "sAjaxSource": "<%=basePath%>service/queryList.do",//这个是请求的地址
                ...
                "aoColumns": [{  
          	                 ...
          	                 }, 
          	                 {
          	                     ...
          	                     "mRender":function(a,b,c,d){//a表示statCleanRevampId对应的值，c表示当前记录行对象  
          	                     	return '<a data-title=\"编辑\" onclick=\"edit(\'编辑\',\'<%=basePath%>service/toEdit.do?ID='+c.ID+'\',\'\',\'550\')\" href=\"javascript:;\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i> 编辑</a>&nbsp<a data-title=\"删除\" href=\"javascript:;\" onclick=\"del(\'<%=basePath%>service/del.do?ID='+c.ID+'\')\" class=\"btn btn-secondary radius\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i> 删除</a>'; 
          	                    }  
          	                 }
          			], 

	...
	<body class="pos-r"> 
		<div>
			...
			<div class="page-container">
				<div class="text-c">  
				     <input type="hidden" value="${CLAN_ID }" id="CLAN_ID" name="CLAN_ID">  
		...
		$(function() {
			...
			table = $('.table-sort').dataTable({
                ...
                "sAjaxSource": "<%=basePath%>clan/queryMemberList.do",//这个是请求的地址
				 ...
				 "fnServerData" : function(sSource, aoData, fnCallback) {  
	                ...
	                var CLAN_ID=$("#CLAN_ID").val(); 
					 $.ajax({
			                ...
			                data : {"aoData":JSON.stringify(aoData),"NAME":NAME,"CLAN_ID":CLAN_ID},//这个是把datatable的一些基本数据传给后台,比如起始位置,每页显示的行数
			                type : 'post',
			                dataType : 'json',
			                async : false,

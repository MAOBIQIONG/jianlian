...
function save(){
	...
	$.post(url,postData,function(result){
		...
		//$('body').dialog('closeCurrent');
	});
	
} 

/* function ztree_returnjson(){
	return JSON.parse('${zTreeNodes}');
} */

<%-- <link type="text/css" rel="stylesheet" href="<%=basePath%>static/plugins/zTree/2.6/zTreeStyle.css"/> 
<div class="bjui-pageContent">
	<div id="zhongxin">
		<ul id="ztree" class="ztree" data-toggle="ztree" data-options="{nodes:'ztree_returnjson',checkEnable:true}"></ul>
	</div>
...
<div class="bjui-pageFooter">
	<ul>
		...
		<li><button type="button" onclick="save()" class="btn-default" data-icon="save">保存</button>
		</li>
	</ul>
</div> --%>

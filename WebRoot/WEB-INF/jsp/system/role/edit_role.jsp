	...
	<form class="form form-horizontal" id="form-role-edit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<input type="text" class="input-text" value="${pd.ROLE_NAME}"  placeholder="这里输入名称" title="名称" id="roleName" name="ROLE_NAME">
			</div>
		</div> 
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2"> 
				<input class="btn btn-primary radius" onclick="role_save()" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
			</div>
		</div>
	</form>
</article>

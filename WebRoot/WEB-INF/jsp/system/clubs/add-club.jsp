	...
	<body class="pos-r">  
		<article class="page-container">
			...
			<input type="hidden" name="STATUS"  id="STATUS" value="0"/>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>场地租用时间：</label>
					<%-- <div class="formControls col-xs-8 col-sm-9">
						<input type="text" value="${clubData.START_DATE}"  id="START_DATE" name="START_DATE" data-rule-required="true" class="input-text">
					</div> --%>
					<div class="formControls col-xs-8 col-sm-9"> 
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>场地租用类型：</label>
					<div class="formControls col-xs-8 col-sm-9"> 

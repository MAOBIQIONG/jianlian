	...
	<body>
		<article class="page-container">
			<form class="form form-horizontal" id="form-project-add">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${pd.VERSION}" placeholder="" id="VERSION" name="VERSION" data-rule-required="true">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">描述：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${pd.DESP}" placeholder="" id="DESP" name="DESP" data-rule-required="true">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
		 ...
		 function project_save(){ 
				...
				$.ajax({
	                url : "<%=basePath%>jl_cachelist/save.do",
